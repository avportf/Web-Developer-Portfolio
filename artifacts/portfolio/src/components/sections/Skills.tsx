        ...
        >
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8 text-sm">
             <div className="space-y-3">
               <h4 className="text-primary font-mono mb-4">Frontend</h4>
             ...
             <div className="space-y-3">
               <h4 className="text-primary font-mono mb-4">Backend</h4>
               <ul className="space-y-2 text-muted-foreground font-mono">
             ...
             <div className="space-y-3">
               <h4 className="text-primary font-mono mb-4">DevOps & Tools</h4>
               <ul className="space-y-2 text-muted-foreground font-mono">
                 <li>Docker</li>
