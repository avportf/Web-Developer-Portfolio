...
const PROJECT_IMAGES = [project1, project2, project3];
const PROJECT_TITLES = ['Nexus Dashboard', 'Aura Commerce', 'FinTrack Mobile'];
const PROJECT_TECH = [
  ['React', 'TypeScript', 'Recharts', 'Tailwind CSS'],
  ['Next.js', 'Stripe', 'Sanity', 'Zustand'],
  ['React Native', 'Node.js', 'PostgreSQL', 'Plaid API'],
];
